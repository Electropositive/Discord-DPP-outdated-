...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref 41fbaca
  WORKING_DIRECTORY "/workspaces/Discord-DPP/deps/sleepy-discord/deps/cpr"
...
if("${show_ref_output}" MATCHES "refs/remotes/41fbaca")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "41fbaca")
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 41fbaca
  WORKING_DIRECTORY "/workspaces/Discord-DPP/deps/sleepy-discord/deps/cpr"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/Discord-DPP/deps/sleepy-discord/deps/cpr/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/Discord-DPP/deps/sleepy-discord/deps/cpr/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
